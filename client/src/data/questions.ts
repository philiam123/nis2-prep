...
export const allQuestions: Question[] = [
  // ========== Avsnitt 1: Vad är NIS2? (Gemensam) ==========
  {
    domain: 0, subtopic: "A1",
  ...
  // ========== Avsnitt 2: Omfattas vi? (Gemensam) ==========
  {
    domain: 0, subtopic: "A2",
  ...
  // ========== Avsnitt 5: Ledningens ansvar (Ledning) ==========
  {
    domain: 1, subtopic: "A5",
  ...
  // ========== Avsnitt 3: De 10 säkerhetsåtgärderna (Gemensam) ==========
  {
    domain: 0, subtopic: "A3",
  ...
  // ========== Avsnitt 6: Incidentrapportering (Ledning) ==========
  {
    domain: 1, subtopic: "A6",
  ...
  // ========== Avsnitt 4: Cyberhot i energisektorn (Gemensam) ==========
  {
    domain: 0, subtopic: "A4",
  ...
  // ========== Avsnitt 8: IT/OT, fysisk säkerhet & kryptografi (Personal) ==========
  {
    domain: 2, subtopic: "A8",
  ...
  // ========== Avsnitt 5: Lösenord och autentisering (Personal) ==========
  {
    domain: 2, subtopic: "A5",
  ...
  // ========== Avsnitt 6: Phishing och social engineering (Personal) ==========
  {
    domain: 2, subtopic: "A6",
  ...
  // ========== Avsnitt 7: Incidenthantering i praktiken (Personal) ==========
  {
    domain: 2, subtopic: "A7",
  ...
  // ========== Avsnitt 7: Leverantörs- och supply chain-säkerhet (Ledning) ==========
  {
    domain: 1, subtopic: "A7",
